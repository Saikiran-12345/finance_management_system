...
class TransactionAdmin(admin.ModelAdmin):
    """
    Highly customized Admin dashboard for Transaction
    """
    save_on_top = True
    list_per_page = 50
    date_hierarchy = 'created_at' if hasattr(Transaction, 'created_at') else None
    ...
    def admin_actions(self, obj):
        return format_html(
            ...
            f"/admin/transactions/transaction/{obj.pk}/change/",
            f"/admin/transactions/transaction/{obj.pk}/change/"
        )
