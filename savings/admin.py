...
class SavingsGoalAdmin(admin.ModelAdmin):
    """
    Highly customized Admin dashboard for SavingsGoal
    """
    save_on_top = True
    list_per_page = 50
    date_hierarchy = 'created_at' if hasattr(SavingsGoal, 'created_at') else None
    ...
    def admin_actions(self, obj):
        return format_html(
            ...
            f"/admin/savings/savingsgoal/{obj.pk}/change/",
            f"/admin/savings/savingsgoal/{obj.pk}/change/"
        )
