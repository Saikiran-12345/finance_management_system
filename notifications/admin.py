...
class NotificationAdmin(admin.ModelAdmin):
    """
    Highly customized Admin dashboard for Notification
    """
    save_on_top = True
    list_per_page = 50
    date_hierarchy = 'created_at' if hasattr(Notification, 'created_at') else None
    ...
    def admin_actions(self, obj):
        return format_html(
            ...
            f"/admin/notifications/notification/{obj.pk}/change/",
            f"/admin/notifications/notification/{obj.pk}/change/"
        )
