...
class ExpenseCategoryAdmin(admin.ModelAdmin):
    """
    Highly customized Admin dashboard for ExpenseCategory
    """
    save_on_top = True
    list_per_page = 50
    date_hierarchy = 'created_at' if hasattr(ExpenseCategory, 'created_at') else None
    ...
    def admin_actions(self, obj):
        return format_html(
            ...
            f"/admin/expenses/expensecategory/{obj.pk}/change/",
            f"/admin/expenses/expensecategory/{obj.pk}/change/"
        )
...
class ExpenseAdmin(admin.ModelAdmin):
    """
    Highly customized Admin dashboard for Expense
    """
    save_on_top = True
    list_per_page = 50
    date_hierarchy = 'created_at' if hasattr(Expense, 'created_at') else None
    ...
    def admin_actions(self, obj):
        return format_html(
            '<a class="button" href="{}">View</a>&nbsp;'
            '<a class="button" href="{}">Edit</a>',
            f"/admin/expenses/expense/{obj.pk}/change/",
            f"/admin/expenses/expense/{obj.pk}/change/"
        )
    admin_actions.short_description = 'Actions'
    admin_actions.allow_tags = True
