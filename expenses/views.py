...
class ExpenseListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        """
        logger.info(f"Fetching Expense list for user {self.request.user}")
...
class ExpenseCreateView(LoginRequiredMixin, CreateView):
    ...
    def form_invalid(self, form):
        ...
        logger.warning(f"Failed to create Expense by user {self.request.user}")
...
class ExpenseUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def form_valid(self, form):
        ...
        logger.info(f"Expense updated by user {self.request.user}")
        return super().form_valid(form)
...
class ExpenseDeleteView(LoginRequiredMixin, DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        logger.info(f"Expense deleted by user {self.request.user}")
